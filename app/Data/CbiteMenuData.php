        ...
        return new BrandMenu(
            ...
            categories: [
                new MenuCategory(
                    ...
                    products: [
                        self::product('01', 'Pickled Chicken Feet - Original Flavor',
                            ...
                            self::SIGNATURE_PRICE, self::IMG . '/01.jpg', self::SIGNATURE_KHR, badge: '⭐ Signature'),
                        self::product('02', 'Pickled Chicken Feet - Spicy & Sour Flavor',
                            ...
                            self::SIGNATURE_PRICE, self::IMG . '/02.jpg', self::SIGNATURE_KHR),
                        self::product('03', 'Pickled Chicken Feet - Mala Flavor',
                            ...
                            self::SIGNATURE_PRICE, self::IMG . '/03.jpg', self::SIGNATURE_KHR),
                        self::product('04', 'Pickled Chicken Feet - Pickled Chili Flavor',
                            ...
                            self::SIGNATURE_PRICE, self::IMG . '/04.jpg', self::SIGNATURE_KHR),
                        self::product('05', 'Pickled Chicken Feet - Garlic Flavor',
                            'Boneless chicken feet marinated in a fragrant garlic brine. Savory, refreshing, and perfect as a cold snack or add-on.',
                            self::SIGNATURE_PRICE, self::IMG . '/05.jpg', self::SIGNATURE_KHR),
                        self::product('06', 'Pickled Pig Ear - Original Flavor',
                            ...
                            self::SIGNATURE_PRICE, self::IMG . '/06.png', self::SIGNATURE_KHR),
                    ]
                ),
                new MenuCategory(
                    code: 'B',
                    ...
                    products: [
                        self::product('07', 'Mini Classic Cold Noodles',
                ...
                new MenuCategory(
                    ...
                    name: 'Hot Snacks',
                    products: [
                        self::product('08', 'French Fries',
                            'Crispy golden French fries, lightly salted.',
                            1.50, self::IMG . '/08.jpg', 6000),
                        self::product('09', 'Chicken Nuggets (6 pcs)',
                            'Crispy chicken nuggets, golden on the outside and tender inside. A perfect hot snack or side dish.',
                            2.80, self::IMG . '/09.jpg', 11000),
                        self::product('10', 'Chicken Nuggets (10 pcs)',
                            'Crispy chicken nuggets, golden on the outside and tender inside. A perfect hot snack or side dish.',
                            4.20, self::IMG . '/10.jpg', 17000),
                    ]
                ),
                new MenuCategory(
                    code: 'D',
                    name: 'Combos & Sets',
                    products: [
                        self::product('11', 'Cold Snack Combo (Cold Noodle, Pickled Chicken Feet, Soft Drink)',
                            "A refreshing combo featuring our signature cold noodles, pickled chicken feet, and one chilled Coke.",
                            6.90, self::IMG . '/11.jpg', 28000, badge: 'Combo'),
                        self::product('12', 'Hot Snack Combo (Chicken Nuggets (6pcs), French Fries, Soft Drink)',
                            'A classic hot snack combo with crispy French fries, 6 pieces of chicken nuggets, and one chilled Coke.',
                            4.70, self::IMG . '/12.jpg', 19000, badge: 'Combo'),
                    ]
                ),
            ]
        );
